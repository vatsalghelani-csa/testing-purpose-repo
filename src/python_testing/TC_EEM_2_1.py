...
# test-runner-run/run1: app/energy-management factoryreset discriminator KVS trace_to_app_args enable_key
# test-runner-run/run1: storage_path commissioning_method discriminator passcode hex_arg endpoint trace_to_script_args_json trace_to_script_args_perfetto
